...
export const SEO = {
  ...
  defaultDescription:
    "Ανθοπωλείο και κηποτεχνικές υπηρεσίες στην Αττική. Άνθη, φυτά, στολισμοί γάμων και βαφτίσεων, συντηρήσεις κήπων, αυτόματα ποτίσματα, κλαδέματα και σχεδιασμός κήπου.",
  keywords: [
    "ανθοπωλείο",
